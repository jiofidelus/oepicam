...
<!-- ************************************************ -->
			...
			<form action="search" method="get" class="w3-panel">
				<input class="w3-input" id="searchInput" name="search" type="search" style="margin-bottom: 10px;" 
...
<!-- Data section -->
		...
		<section class="w3-container w3-section">
			<p>
			Bienvenu dans l'application o-epicam. Cette application permet d'accéder aux données de la plate-forme EPICAM 
			en fonction de votre profil. Avant de lancer une recherche, veillez saisir votre login et votre mot de passe.
			</p>
		</section>
